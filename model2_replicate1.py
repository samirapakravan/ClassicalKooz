...
demography.add_population_split(time=18500, derived=["NA2", "pop2"], ancestral="NA1")
demography.add_population_split(time=1850, derived=["pop1", "Ghost"], ancestral="NA2")
...
ts = msprime.sim_ancestry(sequence_length=100, samples={"pop1": 10, "pop2": 10, "Ghost":10}, demography=demography, random_seed=6779)
...
with open("model2_replicate1.vcf","w") as vcf_file:
