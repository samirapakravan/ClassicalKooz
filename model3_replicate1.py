...
demography.add_population_split(time=18500, derived=["NA2", "pop1"], ancestral="NA1")
demography.add_population_split(time=1850, derived=["pop2", "Ghost"], ancestral="NA2")
...
ts = msprime.sim_ancestry(sequence_length=100, samples={"pop1": 10, "pop2": 10, "Ghost":10}, demography=demography, random_seed=4577)
...
with open("model3_replicate1.vcf","w") as vcf_file:
